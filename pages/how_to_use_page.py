...
class HowToUsePage(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        self.desc = ctk.CTkLabel(
            body,
            text='Watch the tutorial video or proceed to insert the used test kit when ready.',
    ...
    def update_data(self, user_data=None, selected_product=None, product=None, transaction_id=None, **kwargs):
        ...
        print(f"[HOWTO] update_data transaction_id={self.transaction_id}", flush=True)

    def go_to_insert_kit(self):
        self.stop_video()
        print(f"[HOWTO] go_to_insert_kit transaction_id={self.transaction_id}", flush=True)
